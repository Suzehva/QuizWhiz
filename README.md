...
- **💡 Instant Feedback on Your Answers:** The LLM checks how close your responses are to the specific relevant context necessary to answer the question from the real text using Retrieval-Augmented Generation (RAG) powered by **VoyageAI** – giving you feedback to help you learn better.
